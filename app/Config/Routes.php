...
$routes->get('admin/users', 'AdminController::users', ['filter' => 'authadmin']);
$routes->get('admin/users/edit/(:num)', 'AdminController::editUser/$1', ['filter' => 'authadmin']);
$routes->post('admin/users/update/(:num)', 'AdminController::updateUser/$1', ['filter' => 'authadmin']);
$routes->post('admin/users/delete', 'AdminController::deleteUser', ['filter' => 'authadmin']);
$routes->get('my-profile', 'ProfileController::userProfile', ['filter' => 'auth']);
$routes->post('update-profile', 'ProfileController::updateProfile', ['filter' => 'auth']);
