...
<head>
    <title>Login | Damage Claim System</title>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <link href="<?= base_url() ?>assets_/css/bootstrap.min.css" rel="stylesheet">
    <link href="<?= base_url() ?>assets_/css/common.css" rel="stylesheet">

    
    <link href="<?= base_url() ?>assets_/css/theme-01.css" rel="stylesheet">
...
<?php endif; 
 if (session()->has('success')): ?>
            ...
            <path d="M205.24,202.8a2.435,2.435,0,1,0,2.435,2.435A2.438,2.438,0,0,0,205.24,202.8Zm0,3.917a1.482,1.482,0,1,1,1.482-1.482A1.483,1.483,0,0,1,205.24,206.721Z" transform="translate(-202.805 -202.804)"/>
                        ...
                        <div class="row">
                            ...
                            <div class="col-8 d-flex align-items-center">
                                <a href="01_reset.html">Forgot password?</a>
                            </div>
                        </div>
    ...
    <script src="<?= base_url() ?>assets_/js/jquery.min.js"></script>
    <script src="<?= base_url() ?>assets_/js/bootstrap.min.js"></script>
    <script src="<?= base_url() ?>assets_/js/main.js"></script>
    <script src="<?= base_url() ?>assets_/js/demo.js"></script>
